        ...
        <div className="relative w-full max-w-[1440px] h-[600px] sm:h-[879px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
          ...
          <div className="sm:hidden flex flex-col items-center justify-center h-full text-center px-4 py-4">
            ...
            <div className="mb-4">
              <h1 className="text-[36px] leading-[42px] font-normal tracking-[-1.8px] font-sharp-grotesk text-white">
                ...
                <br />
                everything you{" "}
                <span className="font-semibold italic text-[#54E0FF]">
                  build.
                </span>
              </h1>
            </div>
              ...
              <p className="text-[14px] font-light leading-[20px] tracking-[-0.28px] text-[#7a7a83] font-sharp-grotesk">
                {user
                  ? `Welcome back, ${
                    ...
                    }! Ready to showcase your latest projects?`
              ...
              >
                {loading || isNavigating ? (
                  ...
                  <>
                    ...
                    <ArrowRight width={16} height={12} className="ml-2" />
                  </>
                )}
              </Button>
            </div>
          ...
          <div className="hidden sm:block">
            ...
            <div
              className="absolute"
              style={{
                left: "clamp(1rem, 10.3vw, 149px)",
                top: "275px",
                width: "min(457px, 32vw)",
                height: "158px",
              }}
            >
              ...
              >
                {loading || isNavigating ? (
                  ...
                  <>
                    ...
                    <ArrowRight width={24} height={18} className="ml-2" />
                  </>
                )}
              </Button>
            </div>
