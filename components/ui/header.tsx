    ...
    <>
      <header className="relative w-full ">
        <div className="absolute top-[62px] left-1/2 transform -translate-x-1/2 z-10">
          <nav className="bg-[#18181a] rounded-[20px] px-4 sm:px-6 py-3 sm:py-4 shadow-[0px_16px_30.7px_rgba(0,0,0,0.30)] min-w-[320px] sm:min-w-0">
        ...
        {isMobileMenuOpen && (
          <div ref={mobileMenuRef} className="absolute top-[140px] left-1/2 transform -translate-x-1/2 z-20 sm:hidden">
            <div className="bg-[#18181a] rounded-[16px] px-4 py-3 shadow-[0px_16px_30.7px_rgba(0,0,0,0.30)] min-w-[200px]">
